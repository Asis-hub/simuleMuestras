...
<html>
  ...
  <div class="row">
            @foreach ($viewData['lista_por_generos']->reverse()->take(4) as $listaporgenero)
...
<script>
        function showSelect() {
          ...
          document.getElementById("lb_ListaNominalMujeres").innerHTML = "";
          document.getElementById("lb_ListaNominalHombres").innerHTML = "";
  ...
  $('#send').click(function(){
      ...
      console.log({lb_municipio})
        ...
        $.ajax({
          ...
          method : 'get',
          data : {municipio_py : municipio, entidad_py : entidad, URL_lista_nominal_py : URL_lista_nominal},
          dataType : 'json',
